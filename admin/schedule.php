...
<script>
    function addSchedule() {
        ...
        // var bookId = "B" + Math.floor(100000 + Math.random() * 900000)
        // var authorId  = "A" + Math.floor(100000 + Math.random() * 900000 )
        ...
        <div class="row">
            ...
            <form id="addSchedule" method="post" action="process-schedule.php">
                <div id="add-movie-group" class="form-group">
                    <form class="movies" action="" method="">
                ...
                <div id="add-movie-group" class="form-group">
                    <form class="cinema" action="" method="">
                        <select name="cinemaList" id="cinemaList">
