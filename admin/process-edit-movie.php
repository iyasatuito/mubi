<?php
    ...
    $sql = "UPDATE movie SET movieID ='$movID', movieTitle ='$movTitle', movieDescription ='$movDescription', movieDirector = '$movDirector', movieActor = '$movActor', movieDuration = '$movDuration', movieTrailer = '$trailer', isFeatured = '$isFeatured', isScreening = '$isScreening' WHERE movie.movieID = '$movID';";
